 ...
 * --------------
 * Valeurs du exit code/errorlevel
 * 0 - Fichier traité
 * 1/2 - Erreur (J'avais d'autres idées en tête)
 */
...
// Pas inclus, comme ça on peut ajouter des utilisateurs non préparés par la suite.
/*if(rgx.processed.test(linesIn[0])) {
  console.log(true);
} else {
  console.log(false);
}/**/
